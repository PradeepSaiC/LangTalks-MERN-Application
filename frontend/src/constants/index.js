...
export const LANGUAGE_TO_FLAG = {
  english: "gb",       // United Kingdom (can also be "us" if American English)
  hindi: "in",         // India
  bengali: "bd",       // Bangladesh (can also be "in" if focusing on Indian Bengali)
  telugu: "in",
  marathi: "in",
  tamil: "in",         // Sri Lanka also speaks Tamil; use "in" for Indian Tamil
  urdu: "pk",          // Pakistan
  gujarati: "in",
  kannada: "in",
  odia: "in",
